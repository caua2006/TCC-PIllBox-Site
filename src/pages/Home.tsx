...
function Home() {
  return (
    <div>
      ...
      <div className="mb-16">
        {window.innerWidth > 768 ? (
          <div className="md:flex md:items-center md:justify-center">
            ...
            <img src={GirlPhone} alt="" className="w-[550px]"/>
          </div>
        ) : (
      ...
      <div className="flex flex-col items-center gap-3 mb-16 md:flex-row-reverse md:mb-32">
        ...
        <img src={MobileAppImg} alt="" className="w-[600px]"/>
        <Blur className={'top-[2250px]'}/>
      </div>

      <div className="flex flex-col items-center gap-3 mb-16 md:flex-row">
